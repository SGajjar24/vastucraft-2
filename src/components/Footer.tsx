        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <div className="flex space-x-4">
              <a href={SOCIAL_LINKS.INSTAGRAM} target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-surface hover:bg-gold/20 text-stone-400 hover:text-gold transition-all duration-300">
                <Instagram size={18} />
              </a>
              <a href={SOCIAL_LINKS.LINKEDIN} target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-surface hover:bg-gold/20 text-stone-400 hover:text-gold transition-all duration-300">
                <Linkedin size={18} />
              </a>
              <a href={SOCIAL_LINKS.TWITTER} target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-surface hover:bg-gold/20 text-stone-400 hover:text-gold transition-all duration-300">
                <Twitter size={18} />
              </a>
            </div>
          </div>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg font-serif font-semibold text-stone-100 mb-6">Explore</h3>
          ...
          {/* Services */}
          <div>
            <h3 className="text-lg font-serif font-semibold text-stone-100 mb-6">Expertise</h3>
            <ul className="space-y-3">
              {[
          ...
          {/* Contact */}
          <div>
            <h3 className="text-lg font-serif font-semibold text-stone-100 mb-6">Contact</h3>
            <ul className="space-y-4">
              <li className="flex items-start gap-3 text-stone-400 text-sm group">
                ...
                <span>Science City Road,<br />Ahmedabad, Gujarat</span>
              </li>
